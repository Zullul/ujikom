...
class PilihDudi extends Page
{
    protected static string $resource = PrakerinSiswaResource::class;

    protected static string $view = 'filament.resources.prakerin-siswa-resource.pages.pilih-dudi';

    protected static ?string $title = 'Pilih Tempat Prakerin';
    ...
    // Method untuk mengambil data DUDI yang akan ditampilkan di kartu
    ...
    // Helper untuk mendapatkan URL ke halaman create
    public function getCreateUrl($dudiId): string
    {
        // URL ini akan mengarah ke halaman create standar, dengan membawa ID DUDI
        return PrakerinSiswaResource::getUrl('create', ['dudi_id' => $dudiId]);
    }
}
