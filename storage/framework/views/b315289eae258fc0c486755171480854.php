        ...
        <div class="flex justify-between items-center mb-4">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    Untuk Refleksi Minggu ke-<?php echo e($week_number); ?>

                    <!--[if BLOCK]><![endif]--><?php if($prakerin_id): ?>
                        <br>
                        <span class="text-xs text-gray-400">
                            Periode: <?php echo e(\App\Models\Prakerin::find($prakerin_id)?->nama_prakerin); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['tag' => 'a','href' => \App\Filament\Pages\PilihMingguRefleksi::getUrl(),'icon' => 'heroicon-o-arrow-left','color' => 'gray']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['tag' => 'a','href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\App\Filament\Pages\PilihMingguRefleksi::getUrl()),'icon' => 'heroicon-o-arrow-left','color' => 'gray']); ?>
                Kembali
...
<?php endif; ?><?php /**PATH C:\laragon\www\jurnal-pkl\resources\views/filament/pages/pilih-siswa-refleksi.blade.php ENDPATH**/ ?>